...
export interface PromptDefinition {
  ...
  body: string;
  /**
   * Declared input variables, shared across all variants. Each entry declares the variable's type and input-trust flag.
   */
  variables?: {
