...
let vars = SummaryVars { article: "The Nile floods yearly.".into(), max_words: 20 };
...
def.variant;     // => "default"
def.text;        // => "Summarise the following article in 20 words:\n\nThe Nile floods yearly."
concise.variant; // => "concise"
concise.text;    // => "In one sentence, summarise: The Nile floods yearly."
```
...
default.text      # => "Summarise the following article in 20 words:\n\nThe Nile floods yearly."
concise.variant   # => "concise"
concise.text      # => "In one sentence, summarise: The Nile floods yearly."
```
