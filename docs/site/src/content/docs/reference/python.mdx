...
[`Finding`]s. Empty ⇒ the lint passed. The Python mirror of the consumer's [`prompting_press::CheckReport`]. Surfaced **1:1** — the binding adds nothing and interprets nothing. Read-only
